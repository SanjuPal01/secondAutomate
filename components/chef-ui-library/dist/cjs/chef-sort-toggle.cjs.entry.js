...
class ChefSortToggle {
    constructor(hostRef) {
         ...
         */
        this.sort = '';
        this.sortToggled = __chunk_1.createEvent(this, "sort-toggled", 7);
    }
    /**
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { role: "button" }, __chunk_1.h("chef-button", { tertiary: true, onClick: this.onClick.bind(this) }, __chunk_1.h("chef-icon", { class: "asc-icon" }, "arrow_drop_up"), __chunk_1.h("chef-icon", { class: "desc-icon" }, "arrow_drop_down"))));
    }
    onClick() {
        this.toggle();
    }
...
exports.chef_sort_toggle = ChefSortToggle;
