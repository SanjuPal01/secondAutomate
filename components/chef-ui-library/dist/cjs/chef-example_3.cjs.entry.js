...
class ChefExample {
    ...
    render() {
        return ([
            __chunk_1.h("chef-snippet", { class: "example-code", code: this.code }),
            __chunk_1.h("div", { class: "example-display", innerHTML: this.code })
        ]);
    }
    execScripts() {
    ...
    static get style() { return "chef-example{--border-color:var(--chef-grey);display:block;margin:1em 0;border:1px solid var(--border-color)}chef-example .example-code{border-bottom:1px solid var(--chef-grey)}chef-example .example-display{padding:1em}"; }
}

var marked = __chunk_2.createCommonjsModule(function (module, exports) {
(function(root) {
...
class ChefMarkdown {
    ...
    render() {
        ...
        return (__chunk_1.h("div", { innerHTML: parsed }));
    }
    parse(text) {
        return marked.parse(text, { renderer });
    }
    static get style() { return "chef-markdown{display:block}"; }
}

var prism = __chunk_2.createCommonjsModule(function (module) {
/* **********************************************
     Begin prism-core.js
********************************************** */
...
if (typeof __chunk_2.commonjsGlobal !== 'undefined') {
	__chunk_2.commonjsGlobal.Prism = Prism;
}
...
class ChefSnippet {
    ...
    render() {
        ...
        return (this.code.length ? (__chunk_1.h("pre", { innerHTML: highlighted })) : '');
    }
