...
class ChefProgressBar {
    ...
    render() {
        const progressText = this.hasProgressText ? (__chunk_1.h("div", { class: "progress-text", "aria-hidden": true }, __chunk_1.h("div", { class: "prefix" }, this.prefixText), __chunk_1.h("div", { class: "suffix" }, this.suffixText))) : null;
        const valueStyle = { width: `${(this.value / (this.valueMax - this.valueMin)) * 100}%` };
        const progressBars = (__chunk_1.h("div", { class: "progress-bars", "aria-hidden": true }, __chunk_1.h("div", { class: "bar total" }), __chunk_1.h("div", { class: "bar value", style: valueStyle })));
        return (__chunk_1.h(__chunk_1.Host, { role: "progressbar", "aria-valuenow": this.ariaValueNow, "aria-valuemin": this.ariaValueMin, "aria-valuemax": this.ariaValueMax, "aria-valuetext": this.ariaValueText }, progressText, progressBars));
    }
...
exports.chef_progress_bar = ChefProgressBar;
