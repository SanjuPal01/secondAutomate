...
class ChefButton {
    ...
    render() {
        const link = (__chunk_1.h("a", { href: this.url, target: this.target }, __chunk_1.h("slot", null)));
        const button = (__chunk_1.h("button", { type: this.type, form: this.form, disabled: this.disabled, "aria-disabled": this.disabled }, __chunk_1.h("slot", null)));
        return (__chunk_1.h(__chunk_1.Host, { "aria-disabled": this.disabled }, this.url ? link : button));
    }
...
class ChefIcon {
    ...
    static get style() { return "chef-icon{font-family:Material Icons;font-weight:400;font-style:normal;font-size:inherit;color:inherit;line-height:1;letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;direction:ltr;-webkit-font-feature-settings:\"liga\";font-feature-settings:\"liga\";-webkit-font-smoothing:antialiased}"; }
}

exports.chef_button = ChefButton;
exports.chef_icon = ChefIcon;
