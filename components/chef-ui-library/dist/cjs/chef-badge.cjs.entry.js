...
class ChefBadge {
    ...
    render() {
        const tooltip = this.tooltip ? __chunk_1.h("chef-tooltip", { for: this.id }, this.tooltip) : null;
        const badge = (__chunk_1.h("div", { class: "badge", id: this.id, "no-data": this.noData }, __chunk_1.h("slot", null)));
