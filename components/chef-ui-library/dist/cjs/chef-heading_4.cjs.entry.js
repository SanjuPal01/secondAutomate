...
class ChefHeading {
    ...
    render() {
        return (__chunk_1.h("h1", { class: "page-title" }, __chunk_1.h("slot", null)));
    }
...
class ChefPageHeader {
    ...
    render() {
        return (__chunk_1.h("header", null, __chunk_1.h("slot", null), __chunk_1.h("div", { class: "header-buttons" }, __chunk_1.h("slot", { name: "header-buttons" }))));
    }
...
class ChefSubheading {
    ...
    render() {
        return (__chunk_1.h("p", { class: "page-subtitle" }, __chunk_1.h("slot", null)));
    }
...
exports.chef_heading = ChefHeading;
exports.chef_loading_spinner = ChefLoadingSpinner;
exports.chef_page_header = ChefPageHeader;
exports.chef_subheading = ChefSubheading;
