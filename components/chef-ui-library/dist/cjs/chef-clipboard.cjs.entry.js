...
class ChefClipboard {
    ...
    render() {
        ...
        return (this.plain ?
            [
                __chunk_1.h("div", Object.assign({ id: buttonId }, this.buttonProps), this.icon ? __chunk_1.h("chef-icon", null, this.icon) : '', this.label ? __chunk_1.h("span", { class: "clipboard-label" }, this.label) : '')
            ] :
            [
                __chunk_1.h("chef-button", Object.assign({ id: buttonId }, this.buttonProps), this.icon ? __chunk_1.h("chef-icon", null, this.icon) : '', this.label ? __chunk_1.h("span", { class: "clipboard-label" }, this.label) : ''),
                __chunk_1.h("chef-tooltip", { for: buttonId }, this.tooltipText)
            ]);
    }
}

exports.chef_clipboard = ChefClipboard;
