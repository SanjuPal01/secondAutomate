...
declare namespace LocalJSX {
  interface ChefAlert extends JSXBase.HTMLAttributes<HTMLChefAlertElement> {
    /**
    * The alert type (either 'success' or 'error')
    */
    'type'?: string;
  }
  interface ChefAside extends JSXBase.HTMLAttributes<HTMLChefAsideElement> {}
  interface ChefBadge extends JSXBase.HTMLAttributes<HTMLChefBadgeElement> {
    /**
    * The ID of the element to attach the tooltip
    */
    'id'?: string;
  ...
  interface ChefBanner extends JSXBase.HTMLAttributes<HTMLChefBannerElement> {
    /**
    * The text of the chef-button. If nothing is passed, there will not be a button.
    */
    'buttonText'?: string;
  ...
  interface ChefButton extends JSXBase.HTMLAttributes<HTMLChefButtonElement> {
    /**
    * Indicate button as potentially dangerous
    */
    'caution'?: boolean;
  ...
  interface ChefCard extends JSXBase.HTMLAttributes<HTMLChefCardElement> {}
  interface ChefCheckbox extends JSXBase.HTMLAttributes<HTMLChefCheckboxElement> {
    'checked'?: boolean;
    'disabled'?: boolean;
    'indeterminate'?: boolean;
    'onChange'?: (event: CustomEvent<any>) => void;
  }
  interface ChefClickOutside extends JSXBase.HTMLAttributes<HTMLChefClickOutsideElement> {
    /**
    * Class name to omit. Any click event targets that are on or within an element that has this class name will not dispatch a `clickOutside` event.
    */
    'omit'?: string;
  ...
  interface ChefClipboard extends JSXBase.HTMLAttributes<HTMLChefClipboardElement> {
    /**
    * An optional icon that is displayed by default. To suppress the icon pass in the empty string.
    */
    'icon'?: string;
  ...
  interface ChefColors extends JSXBase.HTMLAttributes<HTMLChefColorsElement> {}
  interface ChefCombobox extends JSXBase.HTMLAttributes<HTMLChefComboboxElement> {
    'onChange'?: (event: CustomEvent<any>) => void;
  }
  interface ChefDataPoint extends JSXBase.HTMLAttributes<HTMLChefDataPointElement> {
  ...
  interface ChefDesignDocs extends JSXBase.HTMLAttributes<HTMLChefDesignDocsElement> {
    'docType'?: string;
    'match'?: any;
  }
  interface ChefDropdown extends JSXBase.HTMLAttributes<HTMLChefDropdownElement> {
    'visible'?: boolean;
  }
  interface ChefExample extends JSXBase.HTMLAttributes<HTMLChefExampleElement> {
    /**
    * The example code to be presented.
    */
    'code'?: string;
  }
  interface ChefExpander extends JSXBase.HTMLAttributes<HTMLChefExpanderElement> {
    /**
    * Indicates that the expander is opened.
    */
    'opened'?: boolean;
  }
  interface ChefHeader extends JSXBase.HTMLAttributes<HTMLChefHeaderElement> {}
  interface ChefHeaderNav extends JSXBase.HTMLAttributes<HTMLChefHeaderNavElement> {}
  interface ChefHeading extends JSXBase.HTMLAttributes<HTMLChefHeadingElement> {}
  interface ChefIcon extends JSXBase.HTMLAttributes<HTMLChefIconElement> {}
  interface ChefInput extends JSXBase.HTMLAttributes<HTMLChefInputElement> {
    /**
    * Enable or disable autocomplete for input (defaults to "off").
    */
    'autocomplete'?: string;
  ...
  interface ChefInputKeyValue extends JSXBase.HTMLAttributes<HTMLChefInputKeyValueElement> {
    /**
    * The placeholder text for the input.
    */
    'placeholder'?: string;
  ...
  interface ChefLayout extends JSXBase.HTMLAttributes<HTMLChefLayoutElement> {}
  interface ChefLibraryApp extends JSXBase.HTMLAttributes<HTMLChefLibraryAppElement> {}
  interface ChefLoadingSpinner extends JSXBase.HTMLAttributes<HTMLChefLoadingSpinnerElement> {
    /**
    * Fixed styling (default is false and displays inline)
    */
    'fixed'?: boolean;
  ...
  interface ChefLogo extends JSXBase.HTMLAttributes<HTMLChefLogoElement> {
    'company'?: string;
  }
  interface ChefMain extends JSXBase.HTMLAttributes<HTMLChefMainElement> {}
  interface ChefMarkdown extends JSXBase.HTMLAttributes<HTMLChefMarkdownElement> {
    /**
    * The markdown text to be parsed.
    */
    'text'?: string;
  }
  interface ChefModal extends JSXBase.HTMLAttributes<HTMLChefModalElement> {
    /**
    * The modal's title. The modal's `aria-labelledby` attribute is set to this value. This should be a unique id, and should match the `id` attribute of the contained element (e.g. `h2`) that actually displays the title of the modal.
    */
    'label'?: string;
  ...
  interface ChefOption extends JSXBase.HTMLAttributes<HTMLChefOptionElement> {
    /**
    * Used to identify different options. This is set automatically so you shouldn't have to change it.
    */
    'optionId'?: string;
  ...
  interface ChefPage extends JSXBase.HTMLAttributes<HTMLChefPageElement> {
    /**
    * Text for cancel button
    */
    'cancelBtnText'?: string;
  ...
  interface ChefPageHeader extends JSXBase.HTMLAttributes<HTMLChefPageHeaderElement> {}
  interface ChefPaginator extends JSXBase.HTMLAttributes<HTMLChefPaginatorElement> {
    /**
    * The current page to highlight. This is the param that you will update on a page change.
    */
    'currentPage'?: string;
  ...
  interface ChefPhatRadio extends JSXBase.HTMLAttributes<HTMLChefPhatRadioElement> {
    /**
    * An optional property that when true allows users to deselect an option by selecting a currently selected option
    */
    'deselectable'?: boolean;
  ...
  interface ChefPill extends JSXBase.HTMLAttributes<HTMLChefPillElement> {}
  interface ChefProgressBar extends JSXBase.HTMLAttributes<HTMLChefProgressBarElement> {
    /**
    * Optional text to display at the start of the progress bar.
    */
    'prefixText'?: string;
  ...
  interface ChefRadialChart extends JSXBase.HTMLAttributes<HTMLChefRadialChartElement> {
    /**
    * The width of the gap (in degrees) to apply between chart segments.
    */
    'gapSize'?: number;
  ...
  interface ChefRadio extends JSXBase.HTMLAttributes<HTMLChefRadioElement> {
    'onChange'?: (event: CustomEvent<any>) => void;
    'onInput'?: (event: CustomEvent<any>) => void;
    /**
    * The value of the currently toggled option.
  ...
  interface ChefReadMe extends JSXBase.HTMLAttributes<HTMLChefReadMeElement> {}
  interface ChefScrollTop extends JSXBase.HTMLAttributes<HTMLChefScrollTopElement> {}
  interface ChefScrollfader extends JSXBase.HTMLAttributes<HTMLChefScrollfaderElement> {}
  interface ChefSelect extends JSXBase.HTMLAttributes<HTMLChefSelectElement> {
    /**
    * Disable your select menu by setting this to true
    */
    'disabled'?: boolean;
  ...
  interface ChefSeparator extends JSXBase.HTMLAttributes<HTMLChefSeparatorElement> {}
  interface ChefSidePanel extends JSXBase.HTMLAttributes<HTMLChefSidePanelElement> {
    /**
    * Boolean to show/hide the side panel
    */
    'visible'?: boolean;
  }
  interface ChefSnippet extends JSXBase.HTMLAttributes<HTMLChefSnippetElement> {
    /**
    * The code snippet to be highlighted.
    */
    'code'?: string;
  ...
  interface ChefSortToggle extends JSXBase.HTMLAttributes<HTMLChefSortToggleElement> {
    /**
  ...
  interface ChefStatusFilterGroup extends JSXBase.HTMLAttributes<HTMLChefStatusFilterGroupElement> {
    'onChange'?: (event: CustomEvent<any>) => void;
    'onInput'?: (event: CustomEvent<any>) => void;
    /**
    * The value of the currently toggled option.
  ...
  interface ChefStep extends JSXBase.HTMLAttributes<HTMLChefStepElement> {
    /**
    * Indicates that the step is disabled.
    */
    'disabled'?: boolean;
  ...
  interface ChefStepper extends JSXBase.HTMLAttributes<HTMLChefStepperElement> {}
  interface ChefSubheading extends JSXBase.HTMLAttributes<HTMLChefSubheadingElement> {}
  interface ChefTabSelector extends JSXBase.HTMLAttributes<HTMLChefTabSelectorElement> {
    'onChange'?: (event: CustomEvent<any>) => void;
    'onInput'?: (event: CustomEvent<any>) => void;
    /**
    * The value of the currently selected tab.
  ...
  interface ChefToggle extends JSXBase.HTMLAttributes<HTMLChefToggleElement> {
    'onChange'?: (event: CustomEvent<any>) => void;
    'onInput'?: (event: CustomEvent<any>) => void;
    /**
    * The value of the currently toggled option.
  ...
  interface ChefToolbar extends JSXBase.HTMLAttributes<HTMLChefToolbarElement> {}
  interface ChefTooltip extends JSXBase.HTMLAttributes<HTMLChefTooltipElement> {
    /**
    * The delay before the tooltip is displayed in milliseconds.
    */
    'delay'?: number;
  ...
  interface ChefTrapFocus extends JSXBase.HTMLAttributes<HTMLChefTrapFocusElement> {
    /**
    * Class name to omit
    */
    'trap'?: boolean;
  }
  interface ChefTypography extends JSXBase.HTMLAttributes<HTMLChefTypographyElement> {}
  interface ChefUiDoc extends JSXBase.HTMLAttributes<HTMLChefUiDocElement> {
    'doc'?: DocEntity;
  }
  interface ChefUiDocs extends JSXBase.HTMLAttributes<HTMLChefUiDocsElement> {
    'docType'?: string;
    'match'?: any;
  }
