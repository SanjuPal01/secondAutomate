...
class ChefButton {
    ...
    render() {
        const link = (h("a", { href: this.url, target: this.target }, h("slot", null)));
        const button = (h("button", { type: this.type, form: this.form, disabled: this.disabled, "aria-disabled": this.disabled }, h("slot", null)));
