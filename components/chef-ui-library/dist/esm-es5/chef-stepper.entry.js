 ...
 * </chef-stepper>
 */
var ChefStepper = /** @class */ (function () {
    function ChefStepper(hostRef) {
        registerInstance(this, hostRef);
    }
    ChefStepper.prototype.render = function () {
        return (h("slot", null));
    };
    Object.defineProperty(ChefStepper, "style", {
        get: function () { return "chef-stepper{display:-ms-flexbox;display:flex;counter-reset:step}chef-stepper chef-step{-ms-flex:1;flex:1}chef-stepper chef-step:before{counter-increment:step;content:counter(step)}"; },
        enumerable: true,
        configurable: true
    });
    return ChefStepper;
