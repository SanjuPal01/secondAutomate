 ...
 * </chef-card>
 */
var ChefCard = /** @class */ (function () {
    function ChefCard(hostRef) {
        registerInstance(this, hostRef);
    }
    ChefCard.prototype.render = function () {
        return [
            h("slot", { name: "label" }),
            h("div", { class: "content" }, h("slot", null))
        ];
    };
    Object.defineProperty(ChefCard, "style", {
        get: function () { return "chef-card{display:block;width:100%}chef-card .content{display:block;padding:1em;background-color:var(--chef-white);-webkit-box-shadow:var(--chef-box-shadow);box-shadow:var(--chef-box-shadow);border-radius:var(--chef-border-radius)}"; },
        enumerable: true,
        configurable: true
    });
    return ChefCard;
