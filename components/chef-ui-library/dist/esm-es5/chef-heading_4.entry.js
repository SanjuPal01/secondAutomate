 ...
 * </chef-page-header>
 */
var ChefHeading = /** @class */ (function () {
    function ChefHeading(hostRef) {
        registerInstance(this, hostRef);
    }
    ChefHeading.prototype.render = function () {
        return (h("h1", { class: "page-title" }, h("slot", null)));
    };
    Object.defineProperty(ChefHeading, "style", {
        get: function () { return "chef-heading .page-title{color:var(--chef-primary-dark);margin-top:0;margin-bottom:12px;font-weight:inherit;font-style:inherit;font-size:18px}"; },
        enumerable: true,
        configurable: true
    });
    return ChefHeading;
 ...
 */
var ChefLoadingSpinner = /** @class */ (function () {
    function ChefLoadingSpinner(hostRef) {
        registerInstance(this, hostRef);
        /**
    ...
    ChefLoadingSpinner.prototype.render = function () {
        var ring = function (d, className) {
    ...
    Object.defineProperty(ChefLoadingSpinner, "style", {
 ...
 * </chef-page-header>
 */
var ChefPageHeader = /** @class */ (function () {
    function ChefPageHeader(hostRef) {
        registerInstance(this, hostRef);
    }
    ChefPageHeader.prototype.componentDidLoad = function () {
        this.el.classList.add('contrasting');
    };
    ChefPageHeader.prototype.render = function () {
        return (h("header", null, h("slot", null), h("div", { class: "header-buttons" }, h("slot", { name: "header-buttons" }))));
    };
    Object.defineProperty(ChefPageHeader.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ChefPageHeader, "style", {
        get: function () { return "chef-page-header{display:block;padding:25px 35px 16px;position:relative;font-style:normal;font-size:13px;color:var(--chef-dark-grey)}chef-page-header chef-heading{font-weight:700}chef-page-header chef-subheading{display:block;color:var(--chef-primary-dark)}chef-page-header.contrasting{background-color:var(--chef-white)}chef-page-header .header-buttons chef-button:first-child{margin-left:0}chef-page-header .header-buttons chef-button:last-child{margin-right:0}\@media (min-width:1024px){chef-page-header .header-buttons{margin:0;position:absolute;top:35px;right:35px}}"; },
        enumerable: true,
        configurable: true
    });
    return ChefPageHeader;
}());
/**
 * @description
 ...
 * </chef-page-header>
 */
var ChefSubheading = /** @class */ (function () {
    function ChefSubheading(hostRef) {
        registerInstance(this, hostRef);
    }
    ChefSubheading.prototype.render = function () {
        return (h("p", { class: "page-subtitle" }, h("slot", null)));
    };
    Object.defineProperty(ChefSubheading, "style", {
        get: function () { return "chef-subheading .page-subtitle{margin-top:0;margin-bottom:0;font-size:inherit;color:var(--chef-dark-grey)}"; },
        enumerable: true,
        configurable: true
    });
    return ChefSubheading;
}());
