...
export class ChefDesignDocs {
        ...
        return (h("chef-layout", null,
            h("chef-aside", { id: "sidebar-nav" },
                h("nav", { "aria-labelledby": "nav2" },
                    h("h2", { id: "nav2", class: "visually-hidden" }, "Design Elements Navigation"),
    ...
    static get is() { return "chef-design-docs"; }
    static get originalStyleUrls() { return {
        "$": ["../chef-ui-docs/chef-ui-docs.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["../chef-ui-docs/chef-ui-docs.css"]
    }; }
