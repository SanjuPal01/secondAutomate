...
export class ChefClipboard {
    ...
    render() {
        ...
        return (this.plain ?
            [
                h("div", Object.assign({ id: buttonId }, this.buttonProps),
                    this.icon ? h("chef-icon", null, this.icon) : '',
                    this.label ? h("span", { class: "clipboard-label" }, this.label) : '')
            ] :
            [
                h("chef-button", Object.assign({ id: buttonId }, this.buttonProps),
                    this.icon ? h("chef-icon", null, this.icon) : '',
                    this.label ? h("span", { class: "clipboard-label" }, this.label) : ''),
                h("chef-tooltip", { for: buttonId }, this.tooltipText)
            ]);
    }
    static get is() { return "chef-clipboard"; }
