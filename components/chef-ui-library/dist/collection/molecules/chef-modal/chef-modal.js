...
export class ChefModal {
    ...
    render() {
        return (h(Host, { class: this.visible ? 'visible' : '' },
            h("div", { class: "modal-overlay", onClick: this.handleClose.bind(this) }),
            h("div", { class: "modal", "aria-modal": "true", role: "dialog", "aria-labelledby": this.label, tabindex: "0" },
                h("chef-trap-focus", null,
                    this.renderButton(),
                    h("slot", { name: "title" }),
                    h("slot", null)))));
    }
    renderButton() {
        if (!this.locked) {
            return (h("chef-button", { class: "close", onClick: this.handleClose.bind(this), secondary: true },
                h("chef-icon", null, "close")));
        }
        return '';
    }
    ...
    static get is() { return "chef-modal"; }
